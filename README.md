...
This fork of Evosoro provides Python 3 version of the library, and is used for my personal research.
...
Install Qt and QMake if you have not already done so, specifically these packages: "libqt4-dev", "qt4-qmake", "libqwt-dev", "freeglut3-dev" and "zlib1g-dev".
    ...
    sudo apt-get install libqt4-opengl-dev qt4-qmake libqwt-dev freeglut3-dev zlib1g-dev
